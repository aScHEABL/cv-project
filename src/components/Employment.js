...
const Employment = () => {
    ...
    return(
        <div className="py-4 px-8 gap-3 grid grid-cols-[1fr_1fr] bg-component-gray h-fit w-full rounded-xl">
            ...
            <input className="bg-input-box-gray h-12 rounded px-3" placeholder="Job Title" />
            <input className="bg-input-box-gray h-12 rounded px-3" placeholder="Employer" />
            ...
            <textarea className="h-32 col-span-2 bg-input-box-gray rounded px-3 py-3" 
