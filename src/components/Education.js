    ...
    render() {
        return(
            <div className="py-4 px-8 gap-3 grid grid-cols-[1fr_1fr] bg-component-gray h-fit w-full rounded-xl">
                ...
                <input className="bg-input-box-gray h-12 rounded px-3 text-white" placeholder="School" />
                <input className="bg-input-box-gray h-12 rounded px-3 text-white" placeholder="Degree" />
