            ...
            <div className="flex flex-col bg-component-gray gap-6 p-5">
                <div className="pb-5">
                    ...
                    <div className="flex flex-wrap gap-2">
                        <div className="flex text-white text-[10px] gap-2 tracking-wide font-work-sans font-normal text-[#a6a6a6]">
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                        <h3 className="text-white text-[12px] font-work-sans font-medium">University of Chicago</h3>
                        <p className="text-white text-[11px] font-work-sans font-normal text-[#a6a6a6]">Master of Science</p>
                        <div className="flex gap-1 w-full">
                            <p className="text-white text-[10px] font-work-sans font-normal text-[#a6a6a6]">2010</p>
                            <p className="text-white text-[10px] font-work-sans font-normal text-[#a6a6a6]">-</p>
                            <p className="text-white text-[10px] font-work-sans font-normal text-[#a6a6a6]">2014</p>
                        </div>
                    </div>
                </div>
                <div>
